...
""" % bcb_dev)
  ...
  if GetBuildProp("ro.aos.display.version", OPTIONS.info_dict) is not None:
    buildid = GetBuildProp("ro.aos.display.version", OPTIONS.info_dict)
    ...
    device = GetBuildProp("ro.aos.device", OPTIONS.info_dict)
...
""" % bcb_dev)
  ...
  common.ZipWriteStr(output_zip, "META-INF/org/aos/releasekey",
